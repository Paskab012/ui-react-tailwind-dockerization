...
export default function NewIncome() {
    ...
    return (
        <>
            <button className="py-3 text-sm font-bold text-gray-800 bg-purple-100 rounded-r hover:bg-gray-400" style={{ width: "167px" }}
                            ...
                            <div className="relative flex flex-col w-full bg-white rounded-lg shadow-lg outline-none focus:outline-none">
                                ...
                                <div className="relative flex-auto p-16">
                                    <p className="my-4 -mt-8 text-sm leading-relaxed text-gray-600">
                                        Please provide here your icome details.
                                        <br /><br /><br />
                                        ...
                                        <div class="mb-3 pt-0">
                                            <input type="text" placeholder="Enter your description" class="px-3 py-3 placeholder-blueGray-300 text-gray-800 relative  bg-purple-100 rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full" />
                                        </div>
                                    </p>
                                </div>
                                {/*footer*/}
