                ...
                <div className="w-full sm:px-6">
                    <div className="px-4 py-4 md:px-10 md:py-7">
                        <div className="flex items-center justify-between">
                            <p className="text-base font-bold leading-normal text-gray-800 sm:text-lg md:text-xl lg:text-2xl">Tasks</p>
                    ...
                    <div className="px-4 py-4 bg-white md:py-7 md:px-8 xl:px-10">
                        <div className="items-center justify-between sm:flex">
                            <div className="flex items-center">
                                ...
                                <a href="javascript:void(0)">
                                    <div className="px-8 py-2 ml-4 text-gray-600 rounded-full hover:text-indigo-700 hover:bg-indigo-100 sm:ml-8">
                                        <p>Done</p>
                                    </div>
                                </a>
                                <a href="javascript:void(0)">
                            ...
                            <button onclick="popuphandler(true)" className="inline-flex items-start justify-start px-6 py-3 mt-4 bg-indigo-700 rounded sm:mt-0 hover:bg-indigo-600 focus:outline-none">
                            ...
                            <table className="w-full whitespace-nowrap">
                                <tbody>
                                    <tr className="h-16 border border-gray-100 rounded">
                                        <td>
                                            <div className="ml-5">
                                                <div className="relative flex items-center justify-center flex-shrink-0 w-5 h-5 bg-gray-200 rounded-sm">
                                                    ...
                                                    <div className="text-white bg-indigo-700 rounded-sm check-icon">
                                        ...
                                        <td className>
                                            <div className="flex items-center pl-5">
                                                <p className="mr-2 text-base font-medium leading-none text-gray-700">Marketing Keynote Presentation</p>
                                        ...
                                        <td className="pl-5">
                                            <button className="px-3 py-3 text-sm leading-none text-red-500 bg-red-100 rounded focus:outline-none hover:bg-red-200">Due today at 18:00</button>
                                        </td>
                                        <td className="pl-4">
                                            <button className="px-5 py-3 text-sm leading-none text-gray-600 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">View</button>
                                        </td>
                                        <td>
                                            <div className="relative px-5 pt-2">
                                                ...
                                                {show == 0 && (
                                                    <div className="absolute right-0 z-30 w-24 mr-6 bg-white shadow dropdown-content ">
                                    ...
                                    <tr className="h-16 border border-gray-100 rounded">
                                        ...
                                        <td className>
                                            <div className="flex items-center pl-5">
                                                <p className="mr-2 text-base font-medium leading-none text-gray-700">UX Wireframes</p>
                                            </div>
                                        </td>
                                        <td className="pl-24">
                                            <div className="flex items-center">
                                        ...
                                        <td className="pl-5">
                                            <button className="px-6 py-3 text-sm leading-none text-gray-600 bg-gray-100 rounded focus:outline-none hover:bg-gray-200">Due on 21.02.21</button>
                                        </td>
                                        <td className="pl-4">
                                            <button className="px-5 py-3 text-sm leading-none text-gray-600 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">View</button>
                                        </td>
                                    ...
                                    <tr className="h-16 border border-gray-100 rounded">
                                        ...
                                        <td className="pl-5">
                                            <button className="py-3 text-sm leading-none text-gray-600 bg-gray-100 rounded px-7 focus:outline-none hover:bg-gray-200">Due tomorrow</button>
                                        </td>
                                        <td className="pl-4">
                                            <button className="px-5 py-3 text-sm leading-none text-gray-600 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">View</button>
                                        </td>
                                    ...
                                    <tr className="h-16 border border-gray-100 rounded">
                                        <td>
                                            <div className="ml-5">
                                                <div className="relative flex items-center justify-center flex-shrink-0 w-5 h-5 bg-gray-200 rounded-sm">
                                                    <input defaultChecked type="checkbox" className="absolute w-full h-full opacity-0 cursor-pointer checkbox" />
                                                    <div className="text-white bg-indigo-700 rounded-sm check-icon">
                                                        <svg className="icon icon-tabler icon-tabler-check" xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" />
                                                            <path d="M5 12l5 5l10 -10" />
                                        ...
                                        <td className>
                                            <div className="flex items-center pl-5">
                                                <p className="mr-2 text-base font-medium leading-none text-gray-700">Development Phase 1</p>
                                            </div>
                                        </td>
                                        <td className="pl-24" />
                                        <td className="pl-5" />
                                    ...
                                    <tr className="h-16 border border-gray-100 rounded">
                                        ...
                                        <td className="pl-5">
                                            <button className="py-3 text-sm leading-none text-gray-600 bg-gray-100 rounded px-7 hover:bg-gray-200 focus:outline-none">Due tomorrow</button>
                                        </td>
                                        <td className="pl-4">
                                            <button className="px-5 py-3 text-sm leading-none text-gray-600 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">View</button>
                                        </td>
                                    ...
                                    <tr className="h-16 border border-gray-100 rounded">
                                        ...
                                        <td className="pl-5">
                                            <button className="px-3 py-3 text-sm leading-none text-red-500 bg-red-100 rounded hover:bg-red-200 focus:outline-none">Due Today at 18:00</button>
                                        </td>
                                        <td className="pl-4">
                                            <button className="px-5 py-3 text-sm leading-none text-gray-600 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">View</button>
                                        </td>
                                    ...
                                    <tr className="h-16 border border-gray-100 rounded">
                                        ...
                                        <td className>
                                            <div className="flex items-center pl-5">
                                                <p className="mr-2 text-base font-medium leading-none text-gray-700">Vue integration</p>
                                            </div>
                                        </td>
                                        <td className="pl-24">
                                            <div className="flex items-center">
                                        ...
                                        <td className="pl-5">
                                            <button className="px-3 py-3 text-sm leading-none text-gray-600 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">Due Today at 18:00</button>
                                        </td>
                                        <td className="pl-4">
                                            <button className="px-5 py-3 text-sm leading-none text-gray-600 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">View</button>
                                        </td>
