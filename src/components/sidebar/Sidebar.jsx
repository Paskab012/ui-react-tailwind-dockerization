        ...
        <div >
             <div className="sticky flex flex-col justify-between h-screen bg-purple-100 shadow w-80 sm:relative">
                <div className="px-8">
                    ...
                    <ul className="mt-12 ">
                        <li className="justify-between w-full p-3 mb-6 text-gray-600 cursor-pointer hover:bg-purple-200 br-5 ems-center brflex hover:text-black">
                            <div className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                            </svg>
                                <span className="ml-2 text-sm ">All accounts</span>
                            </div>
                        </li>
                        <li className="flex items-center justify-between w-full p-3 mb-6 text-gray-600 cursor-pointer hover:text-black hover:bg-purple-200">
                            <div className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li className="flex items-center justify-between w-full p-3 mb-6 text-gray-600 cursor-pointer hover:bg-purple-200 hover:text-black">
                            <div className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z" />
                            </svg>
                                <span className="ml-2 text-sm">Equity Bank</span>
                            </div>
                        </li>
                        <li className="flex items-center justify-between w-full p-3 mb-6 text-gray-600 cursor-pointer hover:bg-purple-200 hover:text-black">
                            <div className="flex items-center">
                    ...
                    <div className="px-2 mt-20 border-t border-purple-200">
                    <ul className="flex items-center w-64 bg-gray-800"></ul>
                     </div>
                        <li className="flex items-center w-full mt-10 mb-6 text-gray-600 cursor-pointer hover:text-gray-500">
                ...
                <div className="px-2 mb-20 border-t border-purple-200">
                    <ul className="flex items-center justify-between w-full">
                        <li className="pt-5 pb-3 text-gray-800 cursor-pointer ">
                            <p>Logout</p>
                        </li>
                        <li className="pt-5 pb-3 text-gray-800 cursor-pinter">
            ...
            <div className="absolute z-40 flex-col justify-between w-64 transition duration-150 ease-in-out bg-gray-800 shadow md:h-full sm:hidden" id="mobile-nav">
                <div className="absolute right-0 flex items-center justify-center w-10 h-10 mt-16 -mr-10 bg-gray-800 rounded-tr rounded-br shadow cursor-pointer" id="mobile-toggler" onclick="sidebarHandler()">
                ...
                <div className="px-8">
                    ...
                    <ul className="mt-12">
                        <li className="flex items-center justify-between w-full mb-6 text-gray-300 cursor-pointer hover:text-gray-500">
                            ...
                            <div className="flex items-center justify-center px-3 py-1 text-xs text-gray-500 bg-gray-700 rounded">5</div>
                        </li>
                        <li className="flex items-center justify-between w-full mb-6 text-gray-600 cursor-pointer hover:text-gray-500">
                            <div className="flex items-center">
                            ...
                            <div className="flex items-center justify-center px-3 py-1 text-xs text-gray-500 bg-gray-700 rounded">8</div>
                        </li>
                        <li className="flex items-center justify-between w-full mb-6 text-gray-600 cursor-pointer hover:text-gray-500">
                            <div className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <ul className="flex items-center justify-between w-full bg-gray-800">
                        ...
                        <li className="flex items-center justify-between w-full mb-6 text-gray-600 cursor-pointer hover:text-gray-500">
                           ...
                           <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                            ...
                            <div className="flex items-center justify-center px-3 py-1 text-xs text-gray-500 bg-gray-700 rounded">25</div>
                        </li>
                        <li className="flex items-center justify-between w-full mb-6 text-gray-600 cursor-pointer hover:text-gray-500">
                            <div className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="px-8 border-t border-purple-200">
                    <ul className="flex items-center justify-between w-full bg-gray-800">
